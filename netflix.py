        ...
        if options == "2":
            ...
            if return_split_method:
                    ...
                    while lines_counter < len(combo_lines):
                        ...
                        if full_countries_list_from_dict[counter] == 'UK':
                            ...
                            if [country for country in special_countries if (country in combo_lines[lines_counter])]:
                                ...
                                recurrence += 1
                            lines_counter += 1
                        if [key_word + countries[full_countries_list_from_dict[counter]] for key_word in key_words if (
                                key_word + countries[full_countries_list_from_dict[counter]] in combo_lines[
                            lines_counter])]:
                            combolist_countries.update({full_countries_list_from_dict[counter]: recurrence})
                            recurrence += 1
                        lines_counter += 1
                ...
                for country in combolist_countries:
                    print("\033[38;5;220m{}: \033[38;5;190m{} Accounts in List".format(country.replace("_", " "),
                                                                                       combolist_countries[country]))
                    percentages.update(
                        {country.replace("_", " "): round(combolist_countries[country] / len(combo_lines) * 100, 2)})
                print("\033[38;5;7m\nMore Stats:")
                print("--------------------------------------------\n")
                ...
                if len(combolist_countries.values()) == 0:
                    ...
                    print("\033[38;5;220mMost Represented Country in List: \033[38;5;190m{}".format(
                        list(combolist_countries.keys())
